...
<div class="card-wrapper">
    <div class="card">
        ...
        <!-- Card body -->
        <div class="card-body">
            <form action="{{ route('products.update', $product->slug) }}" method="POST" class="needs-validation" novalidate enctype="multipart/form-data">
                @method('put')
                @csrf
                <div class="form-row">
                    <div class="col-md-4 mb-3">
                        <label class="form-control-label" for="name">Nama Barang</label>
                        <input name="name" class="form-control @error('name') is-invalid @enderror" id="name" placeholder="Nama barang" type="text" value="{{ old('name', $product->name) }}">
                        @error('name')
                    ...
                    <input name="slug" class="form-control @error('slug') is-invalid @enderror" id="slug" placeholder="{{ old('slug') }}" type="hidden" value="{{ old('slug', $product->slug) }}" readonly>
                ...
                <div class="form-row">
                    <div class="col-md-6 mb-3">
                        ...
                        <input name="buy_price" class="form-control @error('buy_price') is-invalid @enderror" id="buyPrice" placeholder="Harga beli" value="{{ old('buy_price', $product->buy_price) }}" type="number">
                        @error('buy_price')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input name="sell_price" class="form-control @error('sell_price') is-invalid @enderror" id="sellPrice" placeholder="Harga jual" value="{{ old('sell_price', $product->sell_price) }}" type="number">
                        @error('sell_price')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
